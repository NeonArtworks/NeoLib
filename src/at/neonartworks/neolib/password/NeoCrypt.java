...
public class NeoCrypt extends NeoFileHandler {
	...
	/**
	 * @author Florian Wagner Class to En and DeCrypt Strings
	 * 
	 */
	...
	public String encrypt(String unenString) {
		...
		bytesEncoded = encoder.encode(unenString.getBytes(StandardCharsets.UTF_8));
	...
	public String decrypt(String enString) {
		...
		byte[] bytesDecoded;
		bytesDecoded = decoder.decode(enString.getBytes(StandardCharsets.UTF_8));
